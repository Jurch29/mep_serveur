    ...
    Server.prototype.start = function () {
        ...
        app.post('/save_order', function (req, res) {
            return __awaiter(this, void 0, void 0, function () {
                var request;
                return __generator(this, function (_a) {
                    request = 'INSERT INTO Orders VALUES (NULL, ' + req.body.user_id + ', ' + req.body.trip_id + ', 0, NOW());';
                    console.log(request);
                    mariadb_instance.execquery(request)
                        .then(function (result_1) {
                        res.write(JSON.stringify(result_1));
        ...
        app.post('/trip_comments_list', function (req, res) {
            return __awaiter(this, void 0, void 0, function () {
                var request;
                return __generator(this, function (_a) {
                    request = 'SELECT Comments.comment_id, Comments.comment_content, Comments.comment_date, Users.user_name FROM Comments, Users WHERE Comments.comment_trip_id = ' + req.body.trip_id + ' AND Comments.comment_user_id = Users.user_id ORDER BY Comments.comment_date;';
                    console.log(request);
                    mariadb_instance.execquery(request)
                        .then(function (result_1) {
                        res.write(JSON.stringify(result_1));
        ...
        app.post('/user_comments_list', function (req, res) {
            return __awaiter(this, void 0, void 0, function () {
                var request;
                return __generator(this, function (_a) {
                    request = 'SELECT Comments.comment_id, Comments.comment_content, Comments.comment_date, Trips.trip_name FROM Comments, Trips WHERE Comments.comment_trip_id = Trips.trip_id AND Comments.comment_user_id = ' + req.body.user_id + ' ORDER BY Comments.comment_date;';
                    console.log(request);
                    mariadb_instance.execquery(request)
                        .then(function (result_1) {
                        res.write(JSON.stringify(result_1));
        ...
        app.post('/verify_if_ordered', function (req, res) {
            return __awaiter(this, void 0, void 0, function () {
                var query;
                return __generator(this, function (_a) {
                    query = {
        ...
        app.post('/user_kart_remove_order', function (req, res) {
            return __awaiter(this, void 0, void 0, function () {
                var request;
                return __generator(this, function (_a) {
                    request = 'DELETE FROM Orders WHERE Orders.order_id = ' + req.body.order_id + ';';
                    console.log(request);
                    mariadb_instance.execquery(request)
                        .then(function (result_1) {
                        res.write(JSON.stringify(result_1));
